<div id="sidebar">
  <nav>
      <ul>
          ...
          <li>
            <!-- This should be the calendar page-->  <a  href="newsfeed" <?php if ($this->router->fetch_class () == 'Newsfeed') echo ' class="active"' ?>> <i id="calendaricon" class="fa fa-calendar fa-3x" style="color:white" aria-hidden="true"></i></a>
          </li>
          <li>
