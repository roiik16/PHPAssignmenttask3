...
class Mycal_model extends CI_Model {
    ...
    function get_calendar_data($year, $month) {
        ...
        $query = $this->db->select('cal_date, cal_data')->from('tbl_calendar')
            ->like('cal_date', "$year-$month", 'after')->get();
    ...
    function add_calendar_data($date, $data) {
        ...
        if ($this->db->select('cal_date')->from('tbl_calendar')
                ->where('cal_date', $date)->count_all_results()) {
